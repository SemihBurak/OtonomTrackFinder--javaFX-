...
public class AStarAlgorithm {
    ...
    public static List<int[]> aStar(int[][] map, int startX, int startY, int destX, int destY, boolean[][] occupiedCells) {
        ...
        while (!openList.isEmpty()) {
            ...
            for (int[] direction : directions) {
                ...
                if (newX >= 0 && newX < 10 && newY >= 0 && newY < 10 && map[newX][newY] != 1 && !closedList[newX][newY] && !occupiedCells[newX][newY]) {
                    double g = current.g;
