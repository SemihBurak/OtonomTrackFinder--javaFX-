                    ...
                    groundImageView.setOnMouseClicked(mouseEvent -> {
                        ...
                        if (isSettingStart.get()) {
                            ...
                            if (isHelicopterMode) {
                                ...
                                vehicle = new EnemyTank("file:Assets/enemytank.gif");
                            } else if (isEnemyHelicopterMode) {
                                vehicle = new EnemyHelicopter("file:Assets/enemyheli.gif");
                            } else {
                                switch (vehicles.size()) {
                                    case 0:
                                        vehicle = new Tank("file:Assets/Hull_01.png");
                                        break;
                                    case 1:
                                        vehicle = new Tank("file:Assets/Hull_02.png");
                                        break;
                                    case 2:
                                        vehicle = new Tank("file:Assets/Hull_03.png");
                                        break;
                                    case 3:
                                        vehicle = new Tank("file:Assets/Hull_04.png");
                                        break;
                                    default:
                                        vehicle = new Tank("file:Assets/Hull_01.png");
                                        break;
    ...
    public void start(Stage stage) {
        ...
        startButton.setOnAction(event -> {
            ...
            for (int i = 0; i < vehicles.size(); i++) {
                ...
                // Find new path using A* algorithm
